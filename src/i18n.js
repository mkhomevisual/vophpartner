...
const dictionaries = {
  ...
  nl: createDictionary({
    ...
    about: { label: 'Over ons', title: 'FMCG-handel en sourcing met een langetermijnvisie.', lead: 'VOPH Partners is een op FMCG gerichte handels- en sourcingpartner. We verbinden merken, logistiek en markten in heel Europa — en bouwen langdurige partnerships, geen eenmalige transacties.', body: 'De groep omvat de One-Shop.cz-franchise met 15 winkels, de groothandelswebshop VOPH.cz en de B2C-webshop Loopy.cz.', stats: [{ value: 5.9, decimals: 1, prefix: '€', suffix: ' mln.', label: 'omzet in 2025' }, { value: 50, suffix: '+', label: 'wederzijdse partnerships' }, { value: 3468, suffix: '+', label: 'verkochte pallets in 2025' }, { value: 10, suffix: '+', label: 'landen van samenwerking in Europa' }], quote: 'We bouwen op vertrouwen, betrouwbaarheid en relaties die langer meegaan dan één transactie.' },
