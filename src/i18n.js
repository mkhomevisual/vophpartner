...
const dictionaries = {
  cs: createDictionary({
    meta: {
      title: 'FMCG Czech Republic: trading a sourcing | VOPH Partners',
      description: 'FMCG Czech Republic: B2B trading, sourcing a distribuce globálních značek pro velkoobchod, retail a velké e-shopy v Česku i celé Evropě.',
    },
    a11y: { skip: 'Přeskočit na obsah', menuOpen: 'Otevřít menu', menuClose: 'Zavřít menu', langLabel: 'Jazyk webu', home: 'VOPH Partners — úvod' },
    ...
    hero: { badge: 'FMCG Czech Republic', titleLines: ['FMCG Czech Republic:', 'trading, sourcing', 'a distribuce'], sub: 'Váš dlouhodobý B2B partner pro český a evropský trh.', support: 'Propojujeme globální značky, logistiku a trhy — pro velkoobchody, retailové řetězce a velké e-shopy.', ctaPrimary: 'Kontaktovat nás', ctaSecondary: 'Zjistit více', chips: ['Sourcing v Evropě i mimo ni', 'Jedno kontaktní místo', 'Rychlá reakce'], scroll: 'Posunout dolů' },
    about: {
      label: 'O nás', title: 'B2B FMCG partner z České republiky pro Evropu.',
      lead: 'VOPH Partners je český partner pro FMCG trading, sourcing a distribuci. Z České republiky propojujeme značky, logistiku a trhy po celé Evropě — a stavíme dlouhodobá partnerství, ne jednorázové obchody.',
      body: 'Součástí skupiny je franšíza 15 prodejen One-Shop.cz, velkoobchodní e-shop VOPH.cz a B2C e-shop Loopy.cz.',
      stats: [{ value: 5.9, decimals: 1, suffix: ' mil. €', label: 'obrat za rok 2025' }, { value: 50, suffix: '+', label: 'oboustranných partnerství' }, { value: 3468, suffix: '+', label: 'prodaných palet v roce 2025' }, { value: 10, suffix: '+', label: 'zemí spolupráce v Evropě' }],
  ...
  en: createDictionary({
    meta: { title: 'FMCG Czech Republic | Trading & Sourcing | VOPH Partners', description: 'FMCG Czech Republic: B2B trading, sourcing and distribution of global brands for wholesalers, retailers and major e-commerce players across Europe.' },
    a11y: { skip: 'Skip to content', menuOpen: 'Open menu', menuClose: 'Close menu', langLabel: 'Site language', home: 'VOPH Partners — home' },
    ...
    hero: { badge: 'FMCG Czech Republic', titleLines: ['FMCG Czech Republic:', 'trading, sourcing', '& distribution'], sub: 'Your long-term B2B partner for the Czech and European markets.', support: 'We connect global brands, logistics and markets — for wholesalers, retail chains and major e-commerce players.', ctaPrimary: 'Contact us', ctaSecondary: 'Learn more', chips: ['Sourcing in Europe & beyond', 'One point of contact', 'Fast response'], scroll: 'Scroll down' },
    about: { label: 'About', title: 'A Czech FMCG partner for European markets.', lead: 'VOPH Partners is a Czech FMCG trading, sourcing and distribution partner. From the Czech Republic, we connect brands, logistics and markets across Europe — and build long-term partnerships, not one-off deals.', body: 'Our group includes the One-Shop.cz franchise with 15 stores, the VOPH.cz wholesale e-shop and the Loopy.cz B2C e-shop.', stats: [{ value: 5.9, decimals: 1, prefix: '€', suffix: 'm', label: 'turnover in 2025' }, { value: 50, suffix: '+', label: 'two-way partnerships' }, { value: 3468, suffix: '+', label: 'pallets sold in 2025' }, { value: 10, suffix: '+', label: 'countries across Europe' }], quote: 'We build on trust, reliability and relationships that last longer than a single deal.' },
  ...
  pl: createDictionary({
    meta: { title: 'FMCG Czech Republic | Handel i sourcing | VOPH Partners', description: 'VOPH Partners to czeski partner B2B w handlu, sourcingu i dystrybucji FMCG dla hurtowni, sieci detalicznych i e-commerce w Czechach i Europie.' },
    a11y: { skip: 'Przejdź do treści', menuOpen: 'Otwórz menu', menuClose: 'Zamknij menu', langLabel: 'Język strony', home: 'VOPH Partners — strona główna' },
  ...
  de: createDictionary({
    meta: { title: 'FMCG Czech Republic | Handel & Sourcing | VOPH Partners', description: 'VOPH Partners ist Ihr tschechischer B2B-Partner für FMCG-Handel, Sourcing und Distribution globaler Marken in Tschechien und ganz Europa.' },
    a11y: { skip: 'Zum Inhalt springen', menuOpen: 'Menü öffnen', menuClose: 'Menü schließen', langLabel: 'Sprache der Website', home: 'VOPH Partners — Startseite' },
  ...
  hu: createDictionary({
    meta: { title: 'FMCG Czech Republic | Kereskedelem | VOPH Partners', description: 'A VOPH Partners csehországi B2B partner FMCG kereskedelemhez, sourcinghoz és disztribúcióhoz nagykereskedők, üzletláncok és e-kereskedők számára.' },
    a11y: { skip: 'Ugrás a tartalomra', menuOpen: 'Menü megnyitása', menuClose: 'Menü bezárása', langLabel: 'Weboldal nyelve', home: 'VOPH Partners — kezdőlap' },
  ...
  fr: createDictionary({
    meta: { title: 'FMCG Czech Republic | Négoce & sourcing | VOPH Partners', description: 'VOPH Partners est un partenaire B2B tchèque pour le négoce, le sourcing et la distribution FMCG de marques mondiales en République tchèque et en Europe.' },
    a11y: { skip: 'Aller au contenu', menuOpen: 'Ouvrir le menu', menuClose: 'Fermer le menu', langLabel: 'Langue du site', home: 'VOPH Partners — accueil' },
  ...
  nl: createDictionary({
    meta: { title: 'FMCG Czech Republic | Handel & sourcing | VOPH Partners', description: 'VOPH Partners is een Tsjechische B2B-partner voor FMCG-handel, sourcing en distributie van wereldmerken in Tsjechië en andere Europese markten.' },
    a11y: { skip: 'Ga naar inhoud', menuOpen: 'Menu openen', menuClose: 'Menu sluiten', langLabel: 'Taal van de website', home: 'VOPH Partners — home' },
    ...
    hero: { badge: 'FMCG Czech Republic', titleLines: ['Uw partner voor', 'FMCG-handel en', 'sourcing op lange termijn'], sub: 'Wereldwijde merken. Concurrerende prijzen. Langdurige partnerships.', support: 'We verbinden merken, logistiek en markten — voor groothandels, retailketens en grote e-commercepartijen.', ctaPrimary: 'Neem contact op', ctaSecondary: 'Meer informatie', chips: ['Sourcing in Europa en daarbuiten', 'Eén aanspreekpunt', 'Snelle reactie'], scroll: 'Scroll naar beneden' },
    about: { label: 'Over ons', title: 'Uw Tsjechische FMCG-partner voor Europese markten.', lead: 'VOPH Partners is een Tsjechische partner voor FMCG-handel, sourcing en distributie. Vanuit Tsjechië verbinden we merken, logistiek en markten in heel Europa — en bouwen we langdurige partnerships in plaats van eenmalige transacties.', body: 'De groep omvat de One-Shop.cz-franchise met 15 winkels, de groothandelswebshop VOPH.cz en de B2C-webshop Loopy.cz.', stats: [{ value: 5.9, decimals: 1, prefix: '€', suffix: ' mln.', label: 'omzet in 2025' }, { value: 50, suffix: '+', label: 'wederzijdse partnerships' }, { value: 3468, suffix: '+', label: 'verkochte pallets in 2025' }, { value: 10, suffix: '+', label: 'landen van samenwerking in Europa' }], quote: 'We bouwen op vertrouwen, betrouwbaarheid en relaties die langer meegaan dan één transactie.' },
